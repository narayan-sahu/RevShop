    ...
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td colspan="9" class="text-center">No orders received.</td>
                </tr>
                <%
                        }
                    } else {
                %>
                <tr>
                    <td colspan="9" class="text-center">Seller email not found in session. Please <a href="login_seller.jsp">login</a>.</td>
                </tr>
                <%
                    }
                %>
