...
<head>
    ...
    <style>
        ...
        .product-grid {
            ...
            max-width: 1200px; /* Ensure the grid doesn't exceed a reasonable width */
        ...
        .product-card h3 {
            ...
            margin-bottom: 10px;
            color: #333;
            min-height: 50px; /* Maintain a minimum height for the title */
        }
        .product-card p {
            flex-grow: 1;
            margin-bottom: 10px;
        ...
        .price {
            color: #ff9900; /* Amazon's orange color for prices */
        ...
        .add-to-cart-btn:hover, .buy-btn:hover {
            ...
            background-color: #e47911; /* Slightly darker orange on hover */
        }
        .buy-btn {
