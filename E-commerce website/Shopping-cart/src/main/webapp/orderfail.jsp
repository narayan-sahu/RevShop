...
<head>
    ...
    <style>
        ...
        h2 {
            color: #d9534f; /* Amazon's red color for error messages */
            font-size: 2rem;
            margin-bottom: 20px;
            font-weight: bold;
        }
...
<body>
    <div class="container order-fail-container">
        <h2>Order Failed!</h2>
        <p>Your order was not placed successfully. Please try again.</p>
